                ...
                {filteredKamars.map((kamar) => (
                  <tr key={kamar.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 space-x-2">
                      <button
                        onClick={() => handleUpdateStatus(kamar.id, kamar.status === 'kosong' ? 'terisi' : 'kosong')}
                        className="text-blue-600 hover:text-blue-900 mr-2"
                      >
                        <i className={`ri-${kamar.status === 'kosong' ? 'user-add' : 'user-unfollow'}-line mr-1`}></i>
                        {kamar.status === 'kosong' ? 'Isi' : 'Kosongkan'}
                      </button>
                      <button
